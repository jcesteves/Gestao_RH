...
from .views import HoraExtra, HoraExtraEdite, HoraExtraDelete, HoraExtraCreate, utilizouhoraextra, naousouhoraextra
...
urlpatterns = [
    ...
    path('naoutilizou/<int:pk>/', naousouhoraextra.as_view(), name='naoutilizou_horaextra'),
